...
my $log_layout_template = '%d{ISO8601} [%C] %m{chomp}%n';
...
my $log_conf = qq(
    ...
    log4perl.appender.Screen.layout.ConversionPattern = $log_layout_template
    ...
    log4perl.appender.File.layout.ConversionPattern = $log_layout_template
);
